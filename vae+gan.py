...
def main():
    ...
    # Specify the path to the single audio file to test
    #audio_file_path = "/Users/aiswaryamariamjacob/major-project/7-13.wav"  # update with your file path
    ...
    # Define a threshold for anomaly detection (determine based on validation experiments)
